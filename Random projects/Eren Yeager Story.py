...
Scenario_2 = input("Join the Cadets after growing up to get stronger OR live the rest of your life as a normal person with Mikasa?\nPress C to Join Cadets or L to Live a normal life.\n").lower()
...
Scenario_3 = input("Now do you want to stick with the story and enjoy it like a real main character OR do you want to skip to the \nend scene where your beloved Mikasa is cutting your head? Press S to stick with the story or H to get your head chopped.\n").lower()
